  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center h-full text-white font-poppins">
        <h1 className="text-2xl md:text-4xl text-center font-bold mb-4">Wanna buy a smartphone?</h1>
        <p className="mb-6 text-center text-md">Discover the latest mobile devices and accessories with us.</p>
        <a href="tel:+977 9866985352" className="flex items-center bg-green-500 text-white px-6 py-3 rounded-full shadow-lg hover:bg-green-600 transition duration-300">
